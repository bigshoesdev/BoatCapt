...
class PaymentController extends Controller
{
    ...
    public function index(Request $request) 
    {
        ...
        return view('pages.admin.payments', compact('param'));
    }
    ...
    public function paymentList(Request $request) 
    {
        ...
        $tripPrice = $this->trip->selectSub('SUM(merchant_transactions.amount) * 90', 'sum')
                    ->where('bid_id', '<>', null)
                    ->whereRaw('endTime<UTC_TIMESTAMP')
        ...
        $trips = $this->trip->select('trips.*')
                                    ...
                                    ->selectSub('merchant_transactions.amount * 90', 'payment')
                                    ->selectSub('merchant_transactions.merchant_type', 'merchant_type')

        ...
        <article class="article-page container-768">
            ...
            <div class="captain-view">
                ...
                <div class="aside-left">
                    <template v-if="tripInfo.towCoverage">
                        <p>
                ...
                <div class="aside-right">
                    <template v-if="tripInfo.boatInsurance">
                        <p>
                            <img :src="URL.base + '/public/images/veteran.png'" /> Boat Insurance
                        </p>
                    </template>
                    <template v-if="tripInfo.validSafetyGear">
                        <p>
            ...
            <br/>
            <br/>
            <form class="form-md container-440" :action="URL.base + '/captain-leave-review'" method="POST">
                <div class="row">
                    <div class="col mb-1">
                ...
                <textarea name="describe" v-model="describe" class="form-control mt-3" :placeholder="'How was your trip with Capt. '+tripInfo.firstName+'?'" style="height: 290px;"></textarea>
                <br/>

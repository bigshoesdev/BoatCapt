<template>
    <section>
        <article class="article-page container-768">
            ...
            <h2 class="article-title mb-5">Revenue</h2>
            ...
            <br />
            <br />
            <h4 class="article-title" v-sup="totalPrice" data-suffix=" Gross"></h4>
            <br />
            <br />
                ...
                <table class="table table-borderless table-striped font-opensans">
                    ...
                    <tbody>
                        <tr v-for="trip in tripList">
                            ...
                            <td>
                                <a :href="'/'+trip.tripId+'/admin-book-captain'" class="link-underline">Book</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="text-center" v-if="totalCount > tripList.length">
                <a @click.prevent="getMoreTrip" href="#" class="btn btn-darkblue btn-size-360">Show More Entries</a>
            </div>
            <br />
        </article>
    ...
    export default {
        ...
        methods: {
            getTripList() {
                ...
                this.$http.post(this.URL.base + '/admin-revenue-list', param, {})
                .then(response => {

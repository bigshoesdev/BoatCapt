                ...
                <table class="table table-borderless table-striped font-opensans">
                    ...
                    <tbody>
                        <tr v-for="trip in pendingTripList">
                            ...
                            <td>
                                <a :href="URL.base + '/' + trip.id + '/owner-pending-trip'" class="link-underline">#{{ trip.tripId }}</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            getPendingTripList() {
                this.working = true;
                var vm = this;
                this.$http.post(this.URL.base + '/owner-pending-trips', {}, {})
                .then(response => {
                    var responseData = response.body;
                    vm.pendingCount = responseData.bidRequestCount;
                    vm.pendingTripList = responseData.bidRequestList;
                    this.working = false;
                })
                .catch(error => {
                    this.working = false;
